...
public class BookingMapperTest {
    ...
    void toBookingDtoOutput_FromBooking() {
        ...
        Item item = new Item(1, "Balalaika", "Brand new balalaika", true, owner, null, new BigDecimal("100.00"));
        ...
        assertEquals(booking.getItem().getPrice(), bookingDtoOutput.getItem().getPrice());
