...
public class BookingRepositoryTest {
    ...
    void setup() {
        ...
        this.item = addItem("Balalaika", "Brand new balalaika", true, user, new BigDecimal("100.00"));
    }
...
//        bookingRepository.deleteAll();
    ...
    void findByItemOwnerId() {
        User owner = userRepository.save(new User(3,"test","test@mail.ru"));
        item = addItem("Balalaika", "Brand new balalaika", true, owner, new BigDecimal("100.00"));
    ...
    private Item addItem(String name, String description, boolean available, User owner, BigDecimal price) {
