...
public class ItemDtoWithRequestIdTest {
    ...
    void testSerialize() throws Exception {
        ...
        assertThat(itemDtoSaved).hasJsonPath("$.price");

        assertThat(itemDtoSaved).extractingJsonPathNumberValue("$.id").isEqualTo(itemDto.getId().intValue());
        ...
        assertThat(itemDtoSaved).extractingJsonPathNumberValue("$.requestId").isEqualTo(itemDtoExtended.getRequestId().intValue());
        assertThat(itemDtoSaved).extractingJsonPathNumberValue("$.price").isEqualTo(itemDto.getPrice().doubleValue());
    }
}
//package ru.practicum.shareit.item.dto;
//
