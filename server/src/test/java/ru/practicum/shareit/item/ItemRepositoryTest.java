...
public class ItemRepositoryTest {
    ...
    void setup() {
        ...
        addItem("Balalaika", "Brand new balalaika", true, itemOwner, request, new BigDecimal("100.00"));
    }
    ...
    @Test
    void findByOwnerId() {
        List<Item> itemsSaved = itemRepository.findByOwnerIdOrderByIdAsc(itemOwner.getId());
